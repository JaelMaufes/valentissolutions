      ...
      <div className="container">
        ...
        <div className="lead-capture-grid mt-10">
          <aside className="lead-whatsapp-card">
            ...
            <a className="button button-white mt-7" href={whatsappUrl("Olá! Quero falar com a Valentis.")} target="_blank" rel="noopener noreferrer"><MessageCircle size={17} />Falar pelo WhatsApp</a>
          </aside>
          <div className="lead-form-card">
            <div className="flex items-start justify-between gap-4"><div><p className="eyebrow">Prefere receber contato depois?</p><h3>Deixe seus dados e indique o melhor horário.</h3></div><ShieldCheck className="lead-shield" size={23} aria-hidden="true" /></div>
